					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> Mail us</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div>
					<div class="col-sm-6" >
						<div class="logo pull-left" >
                            <a href="index.php" style="background-color:#0000;color:#000000">Figure Shop
                            <img src="img/partner_7.webp" width="70" height="70"></a>
						</div>
					</div>
					<div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2 class="footer-wid-title">CONNECT WITH US</h2>
                        <!-- <p>//</p> -->
                ...
                <!-- <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">   
                        <h2 class="footer-wid-title">/21/</h2>
                        <ul>
                            <li><a href="#">//</a></li>
                            <li><a href="#">//</a></li>
                        </ul>                        
